<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand">TI Consultores</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    	...
    	<form class="navbar-form navbar-right" action="/buscar">
	        ...
	        @else
	          <div class="dropdown navbar-right">
	            <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
	              <i class="fa fa-user-o" aria-hidden="true"></i><a style="text-decoration: none;">&nbsp&nbsp{{ Auth::user()->name }}&nbsp</a>
          ...
          <li><a href=""><i class="fa fa-inbox" aria-hidden="true"></i>  Bandeja de entrada  <span class="badge">0</span></a></li>
